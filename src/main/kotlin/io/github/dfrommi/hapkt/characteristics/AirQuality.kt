...
public open class AirQuality(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<AirQuality.Value> {
  public override val type: String = "00000095-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Air Quality"
