...
public open class StatusLowBattery(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<StatusLowBattery.Value> {
  public override val type: String = "00000079-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Status Low Battery"
  ...
  Value.BATTERY_LEVEL_NORMAL to 0,
  Value.BATTERY_LEVEL_LOW to 1,
  ))
