...
public open class PairVerify(
  public override val `value`: ByteArray,
  public val command: PairVerify.(ByteArray) -> Unit,
) : ReadableTlvCharacteristic, WritableTlvCharacteristic {
  public override val type: String = "0000004E-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.TLV8

  public override val description: String = "Pair Verify"
