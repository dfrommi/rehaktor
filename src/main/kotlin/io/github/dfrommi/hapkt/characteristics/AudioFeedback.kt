...
public open class AudioFeedback(
  private val observableValue: ObservableValue<Boolean>,
  public val command: AudioFeedback.(Boolean) -> Unit,
) : ObservableBooleanCharacteristic, WritableBooleanCharacteristic {
  public override val type: String = "00000005-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.BOOL

  public override val description: String = "Audio Feedback"
  ...
  public constructor(`value`: Boolean, command: AudioFeedback.(Boolean) -> Unit) :
