...
public open class CurrentVisibilityState(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<CurrentVisibilityState.Value> {
  public override val type: String = "00000135-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Current Visibility State"
  ...
  Value.SHOWN to 0,
  Value.HIDDEN to 1,
  Value.UNKNOWN_1 to 2,
  Value.UNKNOWN_2 to 3,
  ))
