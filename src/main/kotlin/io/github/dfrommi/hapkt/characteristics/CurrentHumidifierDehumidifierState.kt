...
public open class CurrentHumidifierDehumidifierState(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<CurrentHumidifierDehumidifierState.Value> {
  public override val type: String = "000000B3-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Current Humidifier Dehumidifier State"
  ...
  Value.INACTIVE to 0,
  Value.IDLE to 1,
  Value.HUMIDIFYING to 2,
  Value.DEHUMIDIFYING to 3,
  ))
