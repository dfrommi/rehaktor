...
public open class LockCurrentState(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<LockCurrentState.Value> {
  public override val type: String = "0000001D-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Lock Current State"
