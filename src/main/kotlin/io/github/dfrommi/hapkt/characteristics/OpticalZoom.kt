...
public open class OpticalZoom(
  private val observableValue: ObservableValue<Double>,
  public val command: OpticalZoom.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "0000011C-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Optical Zoom"
  ...
  public constructor(`value`: Double, command: OpticalZoom.(Double) -> Unit) :
