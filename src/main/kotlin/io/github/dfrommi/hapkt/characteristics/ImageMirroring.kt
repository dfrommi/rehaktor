...
public open class ImageMirroring(
  private val observableValue: ObservableValue<Boolean>,
  public val command: ImageMirroring.(Boolean) -> Unit,
) : ObservableBooleanCharacteristic, WritableBooleanCharacteristic {
  public override val type: String = "0000011F-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.BOOL

  public override val description: String = "Image Mirroring"
  ...
  public constructor(`value`: Boolean, command: ImageMirroring.(Boolean) -> Unit) :
