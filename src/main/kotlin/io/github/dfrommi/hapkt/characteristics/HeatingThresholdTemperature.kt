...
public open class HeatingThresholdTemperature(
  private val observableValue: ObservableValue<Double>,
  public val command: HeatingThresholdTemperature.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "00000012-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Heating Threshold Temperature"

  public override val range: IntRange? = IntRange(0,25)
  ...
  public constructor(`value`: Double, command: HeatingThresholdTemperature.(Double) -> Unit) :
