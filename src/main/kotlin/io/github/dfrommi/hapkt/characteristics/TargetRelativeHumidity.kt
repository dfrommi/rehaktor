...
public open class TargetRelativeHumidity(
  private val observableValue: ObservableValue<Double>,
  public val command: TargetRelativeHumidity.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "00000034-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Target Relative Humidity"
  ...
  public constructor(`value`: Double, command: TargetRelativeHumidity.(Double) -> Unit) :
