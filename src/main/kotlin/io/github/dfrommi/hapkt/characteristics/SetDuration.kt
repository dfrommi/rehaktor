...
public open class SetDuration(
  private val observableValue: ObservableValue<Int>,
  public val command: SetDuration.(Int) -> Unit,
) : ObservableIntegerCharacteristic, WritableIntegerCharacteristic {
  public override val type: String = "000000D3-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT32

  public override val description: String = "Set Duration"
  ...
  public constructor(`value`: Int, command: SetDuration.(Int) -> Unit) :
