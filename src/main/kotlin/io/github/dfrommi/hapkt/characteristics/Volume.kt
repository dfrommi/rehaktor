...
public open class Volume(
  ...
  public val command: Volume.(Int) -> Unit,
) : ObservableIntegerCharacteristic, WritableIntegerCharacteristic {
  public override val type: String = "00000119-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Volume"
  ...
  public constructor(`value`: Int, command: Volume.(Int) -> Unit) : this(ObservableValue(value),
      command)
