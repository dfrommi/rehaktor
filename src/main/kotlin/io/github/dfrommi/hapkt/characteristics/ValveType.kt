...
public open class ValveType(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<ValveType.Value> {
  public override val type: String = "000000D5-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Valve Type"
  ...
  Value.GENERIC_VALVE to 0,
  Value.IRRIGATION to 1,
  Value.SHOWER_HEAD to 2,
  Value.WATER_FAUCET to 3,
  ))
