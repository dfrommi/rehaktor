...
public open class CoolingThresholdTemperature(
  private val observableValue: ObservableValue<Double>,
  public val command: CoolingThresholdTemperature.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "0000000D-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Cooling Threshold Temperature"

  public override val range: IntRange? = IntRange(10,35)
  ...
  public constructor(`value`: Double, command: CoolingThresholdTemperature.(Double) -> Unit) :
