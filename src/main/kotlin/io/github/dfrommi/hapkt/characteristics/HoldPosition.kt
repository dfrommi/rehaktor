...
public open class HoldPosition(
  public val command: HoldPosition.(Boolean) -> Unit,
) : WritableBooleanCharacteristic {
  public override val type: String = "0000006F-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.BOOL

  public override val description: String = "Hold Position"
