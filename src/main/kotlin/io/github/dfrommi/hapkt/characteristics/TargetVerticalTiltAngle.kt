...
public open class TargetVerticalTiltAngle(
  private val observableValue: ObservableValue<Int>,
  public val command: TargetVerticalTiltAngle.(Int) -> Unit,
) : ObservableIntegerCharacteristic, WritableIntegerCharacteristic {
  public override val type: String = "0000007D-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.INT32

  public override val description: String = "Target Vertical Tilt Angle"
  ...
  public constructor(`value`: Int, command: TargetVerticalTiltAngle.(Int) -> Unit) :
