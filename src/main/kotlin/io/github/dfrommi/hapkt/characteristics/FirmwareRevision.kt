...
public open class FirmwareRevision(
  public override val `value`: String,
) : ReadableStringCharacteristic {
  public override val type: String = "00000052-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.STRING

  public override val description: String = "Firmware Revision"
