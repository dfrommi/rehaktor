...
public open class Saturation(
  private val observableValue: ObservableValue<Double>,
  public val command: Saturation.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "0000002F-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Saturation"
  ...
  public constructor(`value`: Double, command: Saturation.(Double) -> Unit) :
