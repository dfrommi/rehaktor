...
public open class TargetHorizontalTiltAngle(
  private val observableValue: ObservableValue<Int>,
  public val command: TargetHorizontalTiltAngle.(Int) -> Unit,
) : ObservableIntegerCharacteristic, WritableIntegerCharacteristic {
  public override val type: String = "0000007B-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.INT32

  public override val description: String = "Target Horizontal Tilt Angle"
  ...
  public constructor(`value`: Int, command: TargetHorizontalTiltAngle.(Int) -> Unit) :
