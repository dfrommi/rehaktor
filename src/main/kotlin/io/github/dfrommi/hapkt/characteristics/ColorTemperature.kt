...
public open class ColorTemperature(
  private val observableValue: ObservableValue<Int>,
  public val command: ColorTemperature.(Int) -> Unit,
) : ObservableIntegerCharacteristic, WritableIntegerCharacteristic {
  public override val type: String = "000000CE-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT32

  public override val description: String = "Color Temperature"

  public override val range: IntRange? = IntRange(140,500)
  ...
  public constructor(`value`: Int, command: ColorTemperature.(Int) -> Unit) :
