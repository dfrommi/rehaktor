...
public open class RelativeHumidityDehumidifierThreshold(
  private val observableValue: ObservableValue<Double>,
  public val command: RelativeHumidityDehumidifierThreshold.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "000000C9-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Relative Humidity Dehumidifier Threshold"
  ...
  public constructor(`value`: Double,
      command: RelativeHumidityDehumidifierThreshold.(Double) -> Unit) :
