...
public open class Hue(
  private val observableValue: ObservableValue<Double>,
  public val command: Hue.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "00000013-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Hue"

  public override val range: IntRange? = IntRange(0,360)
  ...
  public constructor(`value`: Double, command: Hue.(Double) -> Unit) : this(ObservableValue(value),
      command)
