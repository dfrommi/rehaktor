...
public open class CurrentAirPurifierState(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<CurrentAirPurifierState.Value> {
  public override val type: String = "000000A9-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Current Air Purifier State"
