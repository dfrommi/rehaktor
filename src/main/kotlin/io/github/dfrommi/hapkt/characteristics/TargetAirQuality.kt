...
public open class TargetAirQuality(
  private val observableValue: ObservableValue<Value>,
  public val command: TargetAirQuality.(Value) -> Unit,
) : ObservableFixedValuesCharacteristic<TargetAirQuality.Value>,
    WritableFixedValuesCharacteristic<TargetAirQuality.Value> {
  public override val type: String = "000000AE-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Target Air Quality"
  ...
  Value.EXCELLENT to 0,
  Value.GOOD to 1,
  Value.FAIR to 2,
  ))


  public constructor(`value`: Value, command: TargetAirQuality.(Value) -> Unit) :
