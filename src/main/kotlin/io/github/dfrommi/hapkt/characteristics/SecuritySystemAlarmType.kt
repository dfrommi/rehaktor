...
public open class SecuritySystemAlarmType(
  private val observableValue: ObservableValue<Int>,
) : ObservableIntegerCharacteristic {
  public override val type: String = "0000008E-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Security System Alarm Type"

  public override val range: IntRange? = IntRange(0,1)
