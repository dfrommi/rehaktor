...
public open class SupportedAudioStreamConfiguration(
  public override val `value`: ByteArray,
) : ReadableTlvCharacteristic {
  public override val type: String = "00000115-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.TLV8

  public override val description: String = "Supported Audio Stream Configuration"
