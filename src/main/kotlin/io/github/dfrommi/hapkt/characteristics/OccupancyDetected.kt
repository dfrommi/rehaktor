...
public open class OccupancyDetected(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<OccupancyDetected.Value> {
  public override val type: String = "00000071-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Occupancy Detected"
  ...
  Value.OCCUPANCY_NOT_DETECTED to 0,
  Value.OCCUPANCY_DETECTED to 1,
  ))
