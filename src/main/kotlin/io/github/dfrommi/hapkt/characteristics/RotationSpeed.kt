...
public open class RotationSpeed(
  private val observableValue: ObservableValue<Double>,
  public val command: RotationSpeed.(Double) -> Unit,
) : ObservableDoubleCharacteristic, WritableDoubleCharacteristic {
  public override val type: String = "00000029-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Rotation Speed"
  ...
  public constructor(`value`: Double, command: RotationSpeed.(Double) -> Unit) :
