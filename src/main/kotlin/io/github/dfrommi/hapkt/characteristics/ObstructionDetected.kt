...
public open class ObstructionDetected(
  private val observableValue: ObservableValue<Boolean>,
) : ObservableBooleanCharacteristic {
  public override val type: String = "00000024-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.BOOL

  public override val description: String = "Obstruction Detected"
