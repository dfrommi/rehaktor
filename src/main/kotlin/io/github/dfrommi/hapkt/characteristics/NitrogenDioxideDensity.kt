...
public open class NitrogenDioxideDensity(
  private val observableValue: ObservableValue<Double>,
) : ObservableDoubleCharacteristic {
  public override val type: String = "000000C4-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.FLOAT

  public override val description: String = "Nitrogen Dioxide Density"
