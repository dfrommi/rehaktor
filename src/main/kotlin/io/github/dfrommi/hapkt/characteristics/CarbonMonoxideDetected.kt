...
public open class CarbonMonoxideDetected(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<CarbonMonoxideDetected.Value> {
  public override val type: String = "00000069-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Carbon Monoxide Detected"
  ...
  Value.CO_LEVELS_NORMAL to 0,
  Value.CO_LEVELS_ABNORMAL to 1,
  ))
