...
public open class TargetVisibilityState(
  private val observableValue: ObservableValue<Value>,
  public val command: TargetVisibilityState.(Value) -> Unit,
) : ObservableFixedValuesCharacteristic<TargetVisibilityState.Value>,
    WritableFixedValuesCharacteristic<TargetVisibilityState.Value> {
  public override val type: String = "00000134-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Target Visibility State"
  ...
  public constructor(`value`: Value, command: TargetVisibilityState.(Value) -> Unit) :
