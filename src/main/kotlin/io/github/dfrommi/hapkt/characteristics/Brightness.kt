...
public open class Brightness(
  private val observableValue: ObservableValue<Int>,
  public val command: Brightness.(Int) -> Unit,
) : ObservableIntegerCharacteristic, WritableIntegerCharacteristic {
  public override val type: String = "00000008-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.INT32

  public override val description: String = "Brightness"
  ...
  public constructor(`value`: Int, command: Brightness.(Int) -> Unit) : this(ObservableValue(value),
      command)
