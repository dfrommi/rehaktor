...
public open class ProgrammableSwitchEvent(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<ProgrammableSwitchEvent.Value> {
  public override val type: String = "00000073-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Programmable Switch Event"
  ...
  Value.SINGLE_PRESS to 0,
  Value.DOUBLE_PRESS to 1,
  Value.LONG_PRESS to 2,
  ))
