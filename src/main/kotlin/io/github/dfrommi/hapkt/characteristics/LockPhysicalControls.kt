...
public open class LockPhysicalControls(
  private val observableValue: ObservableValue<Value>,
  public val command: LockPhysicalControls.(Value) -> Unit,
) : ObservableFixedValuesCharacteristic<LockPhysicalControls.Value>,
    WritableFixedValuesCharacteristic<LockPhysicalControls.Value> {
  public override val type: String = "000000A7-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Lock Physical Controls"
  ...
  Value.CONTROL_LOCK_DISABLED to 0,
  Value.CONTROL_LOCK_ENABLED to 1,
  ))


  public constructor(`value`: Value, command: LockPhysicalControls.(Value) -> Unit) :
