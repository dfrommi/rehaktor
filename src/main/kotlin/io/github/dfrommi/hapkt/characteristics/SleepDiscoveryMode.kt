...
public open class SleepDiscoveryMode(
  private val observableValue: ObservableValue<Value>,
) : ObservableFixedValuesCharacteristic<SleepDiscoveryMode.Value> {
  public override val type: String = "000000E8-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Sleep Discovery Mode"
  ...
  Value.NOT_DISCOVERABLE to 0,
  Value.ALWAYS_DISCOVERABLE to 1,
  ))
