...
public open class SelectedRTPStreamConfiguration(
  public override val `value`: ByteArray,
  public val command: SelectedRTPStreamConfiguration.(ByteArray) -> Unit,
) : ReadableTlvCharacteristic, WritableTlvCharacteristic {
  public override val type: String = "00000117-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.TLV8

  public override val description: String = "Selected RTP Stream Configuration"
