...
public open class TargetSlatState(
  private val observableValue: ObservableValue<Value>,
  public val command: TargetSlatState.(Value) -> Unit,
) : ObservableFixedValuesCharacteristic<TargetSlatState.Value>,
    WritableFixedValuesCharacteristic<TargetSlatState.Value> {
  public override val type: String = "000000BE-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Target Slat State"
  ...
  public constructor(`value`: Value, command: TargetSlatState.(Value) -> Unit) :
