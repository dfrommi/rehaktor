...
public open class TemperatureDisplayUnits(
  private val observableValue: ObservableValue<Value>,
  public val command: TemperatureDisplayUnits.(Value) -> Unit,
) : ObservableFixedValuesCharacteristic<TemperatureDisplayUnits.Value>,
    WritableFixedValuesCharacteristic<TemperatureDisplayUnits.Value> {
  public override val type: String = "00000036-0000-1000-8000-0026BB765291"

  public override val format: Format = io.github.dfrommi.hapkt.core.Format.UINT8

  public override val description: String = "Temperature Display Units"
  ...
  Value.CELSIUS to 0,
  Value.FAHRENHEIT to 1,
  ))


  public constructor(`value`: Value, command: TemperatureDisplayUnits.(Value) -> Unit) :
